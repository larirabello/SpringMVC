      ...
      <ul class="clear">
		...
		<li><a class="drop" href="#">Semana 5</a>
          <ul>           
			...
			<li><a href="#">Restful WebServices</a></li>
			 </ul>
        </li>
...
<div class="wrapper">
  <div id="slider">
    <div id="slide-wrapper" class="rounded clear"> 
      <!-- ################################################################################################ -->
      <figure id="slide-1"><a class="view" href="#"><img src="images/demo/foto-sorocaba.jpg" alt=""></a>
     ...
     <ul id="slide-tabs">
        <li><a href="#slide-1">Exercício Final (Lista de Contatos)</a></li>
